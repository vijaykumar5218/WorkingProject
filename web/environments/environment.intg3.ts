const loginBaseUrl = 'https://login5.intg.voya.com/';
export const intgEnvironment3 = {
  production: true,
  baseUrl: '/',
  tokenBaseUrl: 'https://token.intg.app.voya.com/',
  myvoyaBaseUrl: 'https://myvoya-web-my5.intg.voya.com/',
  loginBaseUrl: loginBaseUrl,
  savviBaseUrl: 'https://myhealthwealth.intg.voya.com/',
  myVoyaDomain: 'https://my5.intg.voya.com/',
  tpaPrefix: 'INTG-',
