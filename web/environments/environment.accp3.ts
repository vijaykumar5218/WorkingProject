const loginBaseUrl = 'https://login5.accp.voya.com/';
export const accpEnvironment3 = {
  production: true,
  baseUrl: '/',
  tokenBaseUrl: 'https://token.accp.app.voya.com/',
  myvoyaBaseUrl: 'https://myvoya-web-my5.accp.voya.com/',
  loginBaseUrl: loginBaseUrl,
  myVoyaDomain: 'https://my5.accp.voya.com/',
