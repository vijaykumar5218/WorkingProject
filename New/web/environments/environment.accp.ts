const loginBaseUrl = 'https://login.accp.voya.com/';
export const accpEnvironment = {
  production: true,
  baseUrl: '/',
  tokenBaseUrl: 'https://token.accp.app.voya.com/',
  myvoyaBaseUrl: 'https://myvoya-web.accp.voya.com/',
  loginBaseUrl: loginBaseUrl,
  myVoyaDomain: 'https://my3.accp.voya.com/',
